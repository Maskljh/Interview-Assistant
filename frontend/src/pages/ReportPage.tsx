      ...
      <section className="report screen">
        <section className="workspace-page">
          ...
          <main className="workspace-main">
            <section className="report-card intel-report report-case-file">
              ...
              <article className="closed-report-paper">
                <header>
                  <div>
                    <small>
                ...
                {loading ? (
                  ...
                  <>
                    <section className="report-paper-summary">
                      ...
                      <p>{feedback.summary?.trim() || '暂无总评'}</p>
                    </section>

                    <section className="paper-abilities">
                      <h4>能力判断</h4>
                    ...
                    <section className="report-paper-grid">
                      <div>
                        <h4>本场亮点</h4>
                        <p>
                    ...
                    <div className="rp-extra">
                      ...
                      {behavior && behavior.available && (
                        <article>
                          ...
                          {behavior.face_detected_frames > 0 &&
                          behavior.duration_ms > 0 ? (
                            (() => {
                              ...
                              return (
                                <>
                                  <p>
                                    情绪分布：
                                    {Object.keys(behavior.emotion_distribution)
                                      .length === 0
                                      ? '暂无情绪数据'
                                      : (
                                          (Object.entries(
